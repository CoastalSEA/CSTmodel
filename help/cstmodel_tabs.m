...
% * *Form*: plot the estuary form properties defined for the model and/or
% imported from a user file
% * *X-Plot*: plots the along channel output properties on the tab. The plot cannot be edited.
% * *XT-Plot*: plots the time varying properties at a distance on the tab. The plot cannot be edited.
